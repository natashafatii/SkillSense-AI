                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        // Bullet points
                                        _BulletPoint(
                                          text: AppConstants.hrRegisterPoint1,
                                        ),
                                        const SizedBox(height: 16),
                                        _BulletPoint(
                                          text: AppConstants.hrRegisterPoint2,
                                        ),
                                        const SizedBox(height: 16),
                                        _BulletPoint(
                                          text: AppConstants.hrRegisterPoint3,
                                        ),
                                      ],
                                    ),
                                    ...
                                    child: ConstrainedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          // Title
                                          Text(
                                            AppConstants.hrRegisterRightTitle,
                                            style: GoogleFonts.inter(
                                              fontSize: 26,
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: focusNode.hasFocus
            ? [
                BoxShadow(
                  color: AppColors.webRoleHr.withValues(alpha: 0.12),
                  blurRadius: 10,
